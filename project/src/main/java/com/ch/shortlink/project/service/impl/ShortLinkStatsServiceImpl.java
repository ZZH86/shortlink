...
import com.ch.shortlink.project.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        List<LinkLocalStatsDO> listedLocaleByShortLink = linkLocalStatsMapper.listLocalByShortLink(requestParam);
        ...
        listedLocaleByShortLink.forEach(each -> {
            ...
            ShortLinkStatsLocalCNRespDTO localeCNRespDTO = ShortLinkStatsLocalCNRespDTO.builder()
                    .cnt(each.getCnt())
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        ...
        // 地区访问详情（仅国内）
        List<ShortLinkStatsLocalCNRespDTO> localeCnStats = new ArrayList<>();
        List<LinkLocalStatsDO> listedLocaleByGroup = linkLocalStatsMapper.listLocalByGroup(requestParam);
